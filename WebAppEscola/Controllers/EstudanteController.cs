...
namespace WebAppEscola.Controllers
{
    public class EstudanteController : Controller
    {
        ...
        {
            var estudantes = db.Estudantes.Include(e => e.Enderecos);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EstudanteId,EstudanteNome,DataDeNascimento,Foto,Altura,Peso,NivelEnsinoId")] Estudante estudante)
        {
            if (ModelState.IsValid)
            {
